...
export default function CashOnDeliveryForm(props) {
    const {
        type,
        closeDialogs,
        basePath,
    ...
    const isActive = shopBasicData.payments?.cashOnDelivery?.active || false;
    const verifyContact = shopBasicData.payments?.cashOnDelivery?.contactVerification || false;
